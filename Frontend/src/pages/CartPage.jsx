...
export default function CartPage() {
  ...
  const handleProceed = () => {
    ...
    // placeholder: navigate to checkout or open checkout modal
    // e.g. router.push("/checkout") or open modal
    alert("Proceeding to checkout (implement navigation)");
  };
            ...
            <button
              className={`w-full mt-6 rounded-full px-6 py-3 text-white font-semibold
                         ...
                         transition-opacity duration-150 ${
                           cartItems.length === 0 ? "opacity-50 cursor-not-allowed" : "hover:opacity-90"
                         }`}
